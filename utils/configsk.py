...
class configSetup(object):
    ...
    def set_base_config_options(self):
        ...
        default_opts = [
                ...
                cfg.StrOpt(name = 'ipmi_network', help = 'IPMI network to be reachable from SM', required = True),
                ...
                cfg.StrOpt(name = 'cassandra_db_size', help = 'cassandra db size', required = True),
                ...
                cfg.StrOpt(name = 'vmx_vcp_address', help = 'vMX RE IP address', required = True),
                cfg.StrOpt(name = 'vmx_vfp_address', help = 'vMX PFE IP address', required = True),
                cfg.StrOpt(name = 'vmx_ext_gateway', help = 'vMX External Gateway', required = True),
                cfg.StrOpt(name = 'vmx_asn', help = 'vMX ASN #', required = True),
                cfg.StrOpt(name = 'vmx_loopback_ip', help = 'vMX_loopback_ip', required = True),
                ...
                cfg.StrOpt(name = 'vmximage', help = 'vMX image', required = True),
                cfg.StrOpt(name = 'vsrximage', help = 'vSRX image', required = True),
    ...
    def set_deploy_physical_server_config_options(self):
        ...
        for physical_server in CONF['DEFAULTS']['bms']:
            ...
            physical_server_opts = [
                    ...
                    cfg.StrOpt(name = 'ctrldata_interface', help = 'mgmt nic of server', required = True),
                    cfg.StrOpt(name = 'ctrldata_mac', help = 'mgmt mac address', required = True),
                    cfg.StrOpt(name = 'gateway', help = 'gateway address to reach mgmt', required = True),
                    cfg.StrOpt(name = 'dns-search', help = 'dns-search', required = True),
                    cfg.StrOpt(name = 'dns-servers', help = 'dns-servers', required = True),
                    cfg.StrOpt(name = 'hostname', help = 'hostname', required = True),
                    cfg.StrOpt(name = 'local_user', help = 'local_user', required = True),
