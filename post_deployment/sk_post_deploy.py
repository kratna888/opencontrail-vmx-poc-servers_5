...
class postDeploy(object):
    ...
    def check_contrail_status(self):
        ...
        if re.search(r'NTP state|inactive', res, re.M|re.I):
            ...
            print res
            print "Access to Contrail web-ui from jumphost({}): https://{}:8143/".format(svr1,cc_ctrld_ip)
            print "Access to Openstack Horizon web-ui from jumphost({}): http://{}/horizon".format(svr1,os_ctrld_ip)
